...
class Map{
    public:
                        ...
                        for(int x = 0; x<x_model; x++){
                            if(model[y_model-y-1][x_model-x-1] == 1){
                                ...
                                if(y_coords+y_model-y-1<2){
                                    map[y_coords+y_model-y-1][x_coords+x_model-x-1] = Cell::Hidden;
                                }
                                else{map[y_coords+y_model-y-1][x_coords+x_model-x-1] = Cell::Empty;}
                                map[y_coords+y_model-y-1][x_coords+x_model-x] = Cell::Active;
                            }
                        }
                    }
                    x_coords++;
                ...
                if(k==1){
                    for(int y = 0; y<y_model; y++){
                        for(int x = 0; x<x_model; x++){
                            if(model[y][x] == 1){
                                if(y_coords+y<2){
                                    map[y_coords+y][x_coords+x] = Cell::Hidden;
                                }
                                else{map[y_coords+y][x_coords+x] = Cell::Empty;}
                                map[y_coords+y][x_coords+x-1] = Cell::Active;
                            }
                        }
                    }
                    x_coords--;
                ...
                if(k==1){
                    for(int y = 0; y<y_model; y++){
                        for(int x = 0; x<x_model; x++){
                            if(model[y_model-y-1][x] == 1){
                                if(y_coords+y_model-y-1<2){
                                    map[y_coords+y_model-y-1][x_coords+x] = Cell::Hidden;
                                }
                                else{map[y_coords+y_model-y-1][x_coords+x] = Cell::Empty;}
                                map[y_coords+y_model-y][x_coords+x] = Cell::Active;
                            }
                        }
                    }
                    y_coords++;
                    ...
                    if(y_coords>1){
                        for(int y = 0; y<y_model; y++){
                            for(int x = 0; x<x_model; x++){
                                if(model[y][x] == 1){
                                    map[y_coords+y][x_coords+x] = static_cast<Cell>(color);
                                }
                            }
                        }
                        figure_exist = 0;
        ...
        void clear_full_layers(){
            bool k;
            vector<vector<Cell>> ret = {{Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden},
                                        {Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden},
            ...
            if(x_coords+y_model<=x_map){
                ...
                if(k==1){
                    for(int y = 0; y<y_model; y++){
                        for(int x = 0; x<x_model;x++){
                            if(y_coords+y<2){
                                map[y_coords+y][x_coords+x] = Cell::Active;
                            }
                            else{
                                map[y_coords+y][x_coords+x] = Cell::Empty;
                            }
                        }
                    }
                    int delta = x_model;
    ...
    int x_map = 5;
    int y_map = 7;
    vector<vector<Cell>> map = {{Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden},
                                {Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden,Cell::Hidden},
                                {Cell::Empty,Cell::Empty,Cell::Empty,Cell::Empty,Cell::Empty},
                                {Cell::Empty,Cell::Empty,Cell::Empty,Cell::Empty,Cell::Empty},
                                {Cell::Empty,Cell::Empty,Cell::Empty,Cell::Empty,Cell::Empty},
